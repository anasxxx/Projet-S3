...
<div class="login-container">
    <h1 class="login-title">Send reset password Email</h1>
    <form action="${pageContext.request.contextPath}/ResetpassemailServlet">
        <label for="massar">Enter your Massar</label>
